...
for (let i = 1; i <= textureCount; i++) {
  const texture = textureLoader.load(
    "/keer-site-debug/images/jz/image" + i + ".jpg"
  );
...
//---------------------------------》load image as box
var jzboxTexture = textureLoader.load("/keer-site-debug/images/jiaozhuo2.png");
...
//---------------------------------》load image as floor
var jzTexture = textureLoader.load("/keer-site-debug/images/jiaozhuo.png");
